                    ...
                    <form method="POST" action="{{ url('users/' .$user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="profile_text" type="text" class="form-control @error('profile_text') is-invalid @enderror" name="profile_text" value="{{ $user->profile_text }}" required autocomplete="profile_text" rows="5" autofocus>{{
                                    old('profile_text')
                                }} </textarea>
